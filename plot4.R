...
png("plot4.png", width = 480, height = 480, pointsize = 12, bg = "transparent")
        ...
        # Create northwest plot
        plot(power.sub$DateTime, power.sub$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")
        
        # Create northeast plot
        plot(power.sub$DateTime, power.sub$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
        
        # Create southwest plot
        ...
        legend(x = "topright", legend = leg, lwd = 1, col = colors, bty = "n")
        
        # Create southeast plot
        plot(power.sub$DateTime, power.sub$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
